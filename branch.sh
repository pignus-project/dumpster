pignus-koji add-tag f26 --arches=armv6hl
pignus-koji add-tag f26-image --arches=armv6hl
pignus-koji add-tag f26-stolen --arches=armv6hl
pignus-koji add-tag f26-rebuild --arches=armv6hl

pignus-koji add-tag-inheritance --priority=1 --noconfig f26 f26-stolen
pignus-koji add-tag-inheritance --priority=2 --noconfig f26 f26-rebuild
pignus-koji add-tag-inheritance --priority=10 f26 f25
pignus-koji add-tag-inheritance --priority=1 f26-image f26
...
pignus-koji add-tag-inheritance --priority=1 --noconfig rawhide-image f26-image
